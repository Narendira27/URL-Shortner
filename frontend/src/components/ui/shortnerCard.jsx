export default function ShortnerCard({ onChangeUrlFn, onClickButtonFn }) {
    return (
        <div className="flex flex-col items-center bg-white p-2 mb-8 m-2 lg:m-5 md:pt-5 md:pl-10 md:pr-10 md:pb-5 rounded-lg shadow-2xl w-fit ">
            ...
            <div className="flex mb-8 ">
                ...
                <button onClick={() => { onClickButtonFn() }} className=" bg-blue-400 p-1  md:p-2 text-xs md:text-lg rounded-sm outline-none">Shorten URL</button>
            </div>
